    ...
    <body class="antialiased">
        <div id="app" class="box ">
            ...
            <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
                <span class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 my-font-IYL my-color-b my-f-12 my-select-none text-center">{{(Auth::user()->name == 'None') ? 'بدون نام' : Auth::user()->name}}</span>
                ...
                <div class="navbar-nav">
                  <div class="nav-item text-nowrap">
                    <form action="{{route('logout')}}" method="POST">
                        @csrf
                        <button class="nav-link px-3 my-pointer my-font-IYM my-f-12 btn btn-danger my-sc-0-5" style="color:rgb(255, 255, 255)">Sign out</button>
                    </form>
                  ...
                  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse">
                    <div class="position-sticky pt-3 sidebar-sticky">
                      <ul class="nav flex-column">
                        <li class="nav-item">
                          <a class="nav-link active my-f-12-i my-font-IYL my-color-b-800-i" aria-current="page" href="{{route('user.dashboard')}}" dideo-checked="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home align-text-bottom" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                            صفحه اصلی
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link  my-f-12-i my-font-IYL my-color-b-800-i" href="{{route('user.message')}}" dideo-checked="true">
                        ...
                        <li class="nav-item">
                          <a class="nav-link  my-f-12-i my-font-IYL my-color-b-800-i" href="#" dideo-checked="true">
