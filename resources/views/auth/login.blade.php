        ...
        <div class="page-validation my-obj-center rounded-2 py-3 px-4 my-f-20">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="w-100 mb-3">
                    ...
                    <input type="text" class="my-outline-none form-control text-end my-f-9 py-2 px-3 my-color-b-300 my-font-IYL my-f-12" id="firstName" placeholder="********09" name="mobile" dir="rtl">
                </div>
                @error('mobile')
