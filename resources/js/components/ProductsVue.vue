        ...
        <div class="row bg-white my-4">
            <div class="my-2 col-12  row p-0 ">
                <div class="col-12 col-md-9 row order-2 m-0 my-pos-rel">
                    <div class="col-12 bg-white border-bottom border-1 d-flex align-items-start align-items-start" style="height: 55px;" dir="rtl">
                        <div class="mx-2 my-font-IYL my-f-12 p-2 my-pointer my-color-b-800 my-select-none" @click='sortBy_id()'>جدید / قدیم</div>
                    ...
                    <div v-if="data_filter == null" class="col-12 d-flex overflow-hidden flex-wrap m-0 justify-content-center align-items-start my-pos-abs" style="top:55px" dir="rtl">
                    ...
                    <div v-if="data_filter != null" class="col-12 d-flex overflow-hidden flex-wrap m-0 justify-content-center align-items-start my-pos-abs" style="top:35px" dir="rtl">
                        <div v-for="product in data_filter" loding="lazy"  class="card mx-2 p-1 text-center mt-3 box-view-product" :id="product.id">
                            <div class="my-pos-rel">
                                <img loading="lazy" :src="'/'+product.image_front" style="width: 75%" class="mt-3 card-img-top text-center image-front-product" :alt="product.name">
                            </div>
                            <div class="card-body" dir="rtl">
    ...
    methods: {
        ...
        sortBy_id(){
            if(this.data_filter == null){
                ...
                this.filter_products = this.data_filter
                this.filter_products = this.filter_products.reverse()
            }
        },
        sortBy_max_order(){
            if(this.data_filter == null){
                ...
                this.filter_products = this.data_filter
                this.filter_products = this.filter_products.sort((a, b) => b.max_order - a.max_order)
            }
        },
        sortBy_avg(model){
            if(this.data_filter == null){
                ...
                if(model == 'up'){
                    this.filter_products = this.data_filter
                    this.filter_products = this.filter_products.sort((a, b) => b.avg_price - a.avg_price) ;
                }else{
                    this.filter_products = this.data_filter
                    this.filter_products = this.filter_products.sort((a, b) => a.avg_price - b.avg_price) ;
                }
            }
